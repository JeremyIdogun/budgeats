      ...
      {editing ? (
        <div className="mt-4 flex items-start gap-2">
          <div className="flex-1">
            <div className="flex items-center rounded-lg border border-cream-dark bg-cream px-3 py-2 focus-within:border-navy/40">
          ...
          <button
            ...
            className="rounded-lg bg-navy px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#172744]"
          >
            Set
          </button>
          <button
